...
/**
 * AlgoliaLogo Functional Component.
 */
export default function AlgoliaLogo({ className, title }) {
  return (
    <svg
...
AlgoliaLogo.displayName = 'AlgoliaLogo';
